...
$svgMap = [
    'share' => '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="22px" height="22px" viewBox="0 0 48.665 48.665" style="enable-background:new 0 0 48.665 48.665;" 	 xml:space="preserve"> <g> 	<g> 		<path fill="' . $buttonTransparentIcon . '" d="M40.332,31.592c-2.377,0-4.515,1-6.033,2.598l-17.737-8.686c0.061-0.406,0.103-0.82,0.103-1.246 			c0-0.414-0.04-0.818-0.098-1.215l17.711-8.589c1.519,1.609,3.666,2.619,6.054,2.619c4.603,0,8.333-3.731,8.333-8.333 			c0-4.603-3.73-8.333-8.333-8.333s-8.333,3.73-8.333,8.333c0,0.414,0.04,0.817,0.098,1.215l-17.709,8.589 			c-1.519-1.609-3.666-2.619-6.054-2.619C3.73,15.925,0,19.656,0,24.258c0,4.603,3.73,8.333,8.333,8.333 			c2.377,0,4.515-1,6.033-2.596l17.736,8.685c-0.062,0.406-0.104,0.82-0.104,1.245c0,4.604,3.73,8.333,8.333,8.333 			s8.333-3.729,8.333-8.333C48.665,35.322,44.935,31.592,40.332,31.592z"/> 	</g> </g></svg>',
    ...
    'mediumVolume' => '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" 	 width="24px" height="24px" viewBox="0 0 475.082 475.081" style="enable-background:new 0 0 475.082 475.081;" 	 xml:space="preserve"> <g> 	<g> 		<path fill="' . $buttonPrimaryIcon . '" d="M200.999,63.952c-4.946,0-9.229,1.812-12.847,5.426l-95.074,95.075H18.276c-4.952,0-9.234,1.812-12.85,5.424 			C1.809,173.493,0,177.778,0,182.726v109.63c0,4.949,1.809,9.233,5.426,12.848c3.619,3.617,7.902,5.427,12.85,5.427h74.798 			l95.074,95.078c3.617,3.61,7.9,5.424,12.847,5.424c4.952,0,9.234-1.813,12.85-5.424c3.617-3.614,5.426-7.901,5.426-12.847V82.228 			c0-4.948-1.809-9.234-5.422-12.85C210.23,65.764,205.951,63.952,200.999,63.952z"/> 		<path fill="' . $buttonPrimaryIcon . '" d="M316.769,277.936c8.093-12.467,12.135-25.93,12.135-40.395s-4.042-27.992-12.135-40.556 			c-8.094-12.562-18.791-21.41-32.121-26.551c-1.902-0.949-4.284-1.427-7.139-1.427c-4.944,0-9.232,1.762-12.847,5.282 			c-3.61,3.521-5.427,7.852-5.427,12.99c0,3.997,1.143,7.376,3.432,10.137c2.283,2.762,5.041,5.142,8.282,7.139 			c3.23,1.998,6.468,4.188,9.708,6.567c3.238,2.38,5.996,5.758,8.278,10.135c2.276,4.38,3.426,9.804,3.426,16.277 			c0,6.471-1.143,11.896-3.426,16.276c-2.282,4.381-5.04,7.755-8.278,10.14c-3.24,2.379-6.478,4.569-9.708,6.567 			c-3.241,1.992-5.999,4.377-8.282,7.132c-2.282,2.765-3.432,6.143-3.432,10.14c0,5.144,1.816,9.47,5.427,12.99 			c3.614,3.521,7.902,5.288,12.847,5.288c2.854,0,5.236-0.479,7.139-1.424C297.978,299.304,308.679,290.403,316.769,277.936z"/> 		<path fill="'. $buttonPrimaryIcon . '" d="M377.728,318.194c16.18-24.646,24.273-51.531,24.273-80.654c0-29.124-8.094-56.005-24.273-80.666 			c-16.177-24.645-37.6-42.583-64.241-53.815c-2.471-0.95-4.948-1.427-7.416-1.427c-4.948,0-9.236,1.809-12.854,5.426 			c-3.613,3.616-5.424,7.898-5.424,12.847c0,7.424,3.713,13.039,11.139,16.849c10.657,5.518,17.888,9.705,21.693,12.559 			c14.089,10.28,25.077,23.173,32.976,38.686c7.898,15.514,11.848,32.026,11.848,49.537c0,17.512-3.949,34.023-11.848,49.536 			c-7.898,15.516-18.894,28.407-32.976,38.684c-3.806,2.857-11.036,7.043-21.693,12.563c-7.426,3.809-11.139,9.424-11.139,16.847 			c0,4.948,1.811,9.236,5.424,12.847c3.617,3.621,7.991,5.432,13.131,5.432c2.286,0,4.668-0.483,7.139-1.428 			C340.128,360.783,361.551,342.844,377.728,318.194z"/>  	</g> </g></svg>',
...
.audio-current .audio-current-button-volume.medium span {
	background-image: url('{$svgMap['mediumVolume']}');
}
...
.audio-current .audio-current-button-share:hover {
    border: 1px solid {$buttonTransparentIcon};
    transition: all 0.2s;
}
...
.audio-current  .audio-time {
    color: {$buttonTransparentIcon};
}

.audio-current input.audio-range-volume[type=range] {
    background-color: rgba(255,255,255,0.4);
    background-image: -webkit-gradient(linear, 50% 0%, 50% 100%, color-stop(0%, {$buttonPrimary}), color-stop(100%, {$buttonPrimary}));
    background-image: -webkit-linear-gradient({$buttonPrimary}, {$buttonPrimary});
    background-image: -moz-linear-gradient({$buttonPrimary}, {$buttonPrimary});
    background-image: -o-linear-gradient({$buttonPrimary}, {$buttonPrimary});
    background-image: linear-gradient({$buttonPrimary}, {$buttonPrimary});
}
...
<div class="audio-player-wrap">
    ...
    <div class="audio-current">
        ...
        <div class="audio-current-content">
            <div class="audio-current-content-block">
                ...
                <div class="audio-current-media">
                    <div class="audio-current-media-block">
                    ...
                    <div class="tr-audio">
                        <span class="mobile-volume"></span>
                        <input class="audio-range-volume" type="range" min="0" max="100" value="40">
                    </div>
                ...
                <div class="audio-current-actions">
                    ...
                    <div class="audio-time">
                        <span class="current-time"></span><span> / </span><span class="duration-time"></span>
                    </div>
                </div>
            </div>
        ...
        <?php foreach ($values as $key => $row): ?>
            ...
            <div class="audio-item" data-file="/<?= $row['file'] ?>">
                ...
                <div class="audio-item-name">
                    ...
                    <?php if(isset($row['composer']) && !empty($row['composer'])) : ?><span class="composer"><?= $row['composer'] ?></span><?php endif; ?>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        jQuery('.audio-current').on('input', '.audio-range-volume', function (e) {
            changeVolume(jQuery(this).val());
        });
        ...
        wavesurfer.on('ready', function () {
            ...
            jQuery('.current-time').text('00:00');
            ...
            if(isNaN(duration)) {
                interval = setInterval(function () {
                    ...
                    if(!isNaN(wavesurfer.getDuration())) {
                        duration = wavesurfer.getDuration();
                        jQuery('.duration-time').text(secondsToHms(duration));
        ...
        wavesurfer.on('audioprocess', function () {
            jQuery('.current-time').text(secondsToHms(wavesurfer.getCurrentTime()));
        });
        ...
        function changeVolume(vol) {
            ...
            jQuery('.audio-range-volume').css('background-size', vol + '% 100%').val(vol);

            if(volume > 0 && volume <= 0.5) {
                jQuery('.audio-current-button-volume').removeClass('max').removeClass('min').addClass('medium');
            }

            if(volume > 0.5) {
                jQuery('.audio-current-button-volume').removeClass('medium').removeClass('min').addClass('max');
            }

            if(volume === 0) {
                jQuery('.audio-current-button-volume').removeClass('max').removeClass('medium').addClass('min');
            }
        ...
        function changeTrack(i)
        {
            ...
            let composer = item.find('.composer').text();
            ...
            if(composer !== undefined) {
                jQuery('.audio-current .composer').css('display', 'inline-block');
                jQuery('.audio-current .composer').text(composer);
            } else {
                jQuery('.audio-current .composer').hide();
            }
        ...
        function showTags(url) {
            ...
            if(tags.album !== undefined) {
                ...
                jQuery('.audio-current .album').css('display', 'inline-block');
            } else {
                jQuery('.audio-current .album').hide();
            }
            ...
            if (image) {
                ...
                //TODO сделать переключение интерфейса
